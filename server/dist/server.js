    ...
    try {
      ...
      your response should start with curly braces:
      {
        ...
        const keyAchievement = extractedInfo.related_experience_1.key_achievement ||
            "Unknown Achievement";
        const RelevantSkills = extractedInfo.related_experience_1.relevant_skill || "Unknown Skills";
        const LessonsLearned = extractedInfo.related_experience_1.key_lesson_learned ||
        ...
        const phoneNumber = extractedInfo.applicant_phone_number || "Unknown Phone Number";
        const dateObj = new Date();
        const formattedDate = `${dateObj.getDate()}, ${dateObj.toLocaleDateString("en-us", { month: "short" })}`;
        ...
        const firstParagraoh = (_g = (_f = (_e = completion2.choices) === null || _e === void 0 ? void 0 : _e[0].message) === null || _f === void 0 ? void 0 : _f.content) !== null && _g !== void 0 ? _g : "";
        ...
        const secondParagraph = (_k = (_j = (_h = completion3.choices) === null || _h === void 0 ? void 0 : _h[0].message) === null || _j === void 0 ? void 0 : _j.content) !== null && _k !== void 0 ? _k : "";
